...
function Footer() {
  return (
    <footer className="w-full mt-auto bg-gradient-to-b from-[#2E5C6B] to-[#1a3a42] border-t border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-white font-bold text-xl font-heading">FindIt</span>
            </div>
            <p className="text-white/70 text-sm leading-relaxed">
              Your trusted platform to find, report, and recover lost items in your community.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                className="text-white/60 hover:text-white transition-colors hover:scale-110 transform duration-300"
                href="#"
                aria-label="Facebook"
                title="Facebook"
              >
