...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-40 bg-[#0f172a] text-slate-300 flex flex-col p-4 transform transition-all duration-300 ease-in-out border-r border-white/5 shadow-2xl ${isMobileMenuOpen ? "translate-x-0 w-72" : "-translate-x-full lg:translate-x-0"
