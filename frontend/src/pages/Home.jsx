...
function Home() {
  return (
    <>
      {/* HERO SECTION */}
      <section className="w-full flex flex-col md:flex-row items-center justify-between px-10 py-20 bg-gradient-to-br from-[#2E5C6B] to-[#3D7A8C] text-white overflow-hidden">
        {/* Text Content */}
        ...
        <img
          src="/assets/home.jpg"
          alt="Lost and Found"
          className="w-[320px] md:w-[450px] rounded-2xl shadow-xl mt-10 md:mt-0"
        />
      </section>
