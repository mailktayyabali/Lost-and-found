...
function Contact() {
  const faqs = [
    {
      ...
      answer:
        "Simply navigate to the 'Lost Items' page and click 'Report Lost Item'. Fill in the details such as category, location, and date, and upload a photo if you have one. Our community will be notified immediately.",
      icon: "help",
    },
    {
  ...
  return (
    <main className="flex-grow w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 bg-[#f8f8f5] min-h-screen">
      {/* Header Section */}
      <div className="mb-10 sm:mb-16 text-center md:text-left">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold text-[#212121] mb-4 tracking-tight">
          Contact & Support
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
        ...
        <div className="lg:col-span-5 xl:col-span-4 flex flex-col gap-6">
          ...
          {/* Map Section */}
          <div className="relative w-full h-64 rounded-2xl overflow-hidden border border-gray-200 shadow-sm group">
            <img
      ...
      <div className="mt-20 sm:mt-24 max-w-4xl mx-auto">
        <div className="text-center mb-10">
          <span className="text-[#243DB3] font-bold tracking-wider text-xs uppercase mb-2 block">
            Help Center
          </span>
          <h2 className="text-3xl font-heading font-bold text-[#212121]">
